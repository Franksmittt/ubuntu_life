...
def cta_section() -> str:
    return """        <section class="tj-cta-section section-gap-x ulr-preparedness-cta">
          <div class="container">
            <div class="row">
              <div class="col-12">
                <div class="cta-area">
                  <div class="cta-content">
                    <h2 class="title">Plan Preparedness with Ubuntu Life Resources</h2>
                    ...
                    <div class="cta-btn mt-3 d-flex flex-wrap gap-2 justify-content-center">
