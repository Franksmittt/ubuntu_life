# -*- coding: utf-8 -*-
"""Build scisan-amanzi-content.html from scisan.co.za/sani-amanzi/."""
...
SOURCE_URL = "https://www.scisan.co.za/sani-amanzi/"
SOURCE_HTML = Path("/tmp/scisan-amanzi.html")
OUTPUT = ROOT / "scisan-amanzi-content.html"
PAGE_ID = "2515"
...
BROCHURE_REPLACEMENTS = (
    (
        ...
        'href="#request-brochure" data-ulr-brochure-name="SANI AMANZI Brochure"',
    ),
    (
...
def fetch_source() -> str:
    ...
    request = urllib.request.Request(
        SOURCE_URL,
        headers={"User-Agent": "UbuntuLifeResources/1.0 (amanzi-import)"},
    )
...
def extract_head(html: str) -> str:
    ...
    head = re.sub(
        r"<title>.*?</title>",
        "<title>SANI AMANZI &#8211; Scientific Sanitation Solutions</title>",
        head,
        count=1,
        flags=re.DOTALL,
    )
...
def build_document(html: str) -> str:
    ...
    body_class = (
        "wp-singular page-template-default page page-id-2515 wp-theme-woodmart "
    ...
    return (
        ...
        + body_class
        + "\">\n"
        + '  <main class="ulr-scisan-source-page" aria-label="SANI AMANZI SciSan source content">\n'
        + elementor
        + "\n  </main>\n"
